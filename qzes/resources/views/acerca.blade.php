<x-app-layout>
    ...
    <div class="informacion-2 justify-content-center max-w-7xl mx-auto sm:px-6 lg:px-8 my-4">
        <p style="text-align: center">
            <a href="https://www.instagram.com/elisj2002/"><svg xmlns="http://www.w3.org/2000/svg" width="25"
                    height="25" fill="#c8c8d0" class="bi bi-instagram float-left" viewBox="0 0 16 16">
                    <path
        ...
        &nbsp; <a href="https://github.com/Elisj02"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                fill="#c8c8d0" class="bi bi-github float-right" viewBox="0 0 16 16">
                <path
